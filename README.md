...
默认材料编号采用 MARD 221 色 A–H/M 体系，例如 H2 为白色、H7 为黑色。HEX 依据社区维护的线上色卡整理，仅用于屏幕配色，不代表实物测量值；购买前请核对手中的实体色卡与批次。
