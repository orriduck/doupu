...
- [Perlypop](https://perlypop.com/) — 转换、编辑和按颜色统计的工作流参考。

## 视觉方向

- [Swiss Style overview](https://www.aboutswitzerland.eda.admin.ch/en/swiss-style-forever-the-story-of-a-graphic-design-tradition) — 非对称网格、严格对齐与克制排版。
- [IDEA Magazine media sheet](https://www.seibundo-shinkosha.net/wp-content/uploads/images/mediasheet/mediasheet_idea.pdf) — 日系设计杂志的编辑节奏与大留白参考；界面本身不使用日文。
- [Editorial Web Layout for Magazine](https://dribbble.com/shots/26203538-Editorial-Web-Layout-for-Magazine) — 大标题、留白和图像比例参考。

## 采用的设计原则

- 左侧只承载当前制作方式的操作；中央承载作品；导出动作沿工作区底边形成统一收尾轴。
- 照片转图与自由画板共享项目模型和最终导出，但保留各自的编辑状态。
- 主图控制在页面约一半以内，以留白建立编辑感，不使用应用后台式卡片堆叠。
- 中文衬线标题搭配中性无衬线正文；仅保留中文和少量功能性英文。
- 红色只用于当前状态与交互提示，网格线保持细、轻、可打印。
- 用留白和共享基线组织控件；只在工作流、设置组起点和导出起点使用结构线，不给每一行或每个动作重复加框。
- 尺寸采用小号 52 × 52、标准 74 × 74、大号 104 × 104，默认标准尺寸；图片适配明确区分保持比例的裁切铺满与完整缩放。
