...
interface EditorControlsProps {
  ...
  section?: 'all' | 'setup' | 'color'
}

export function EditorControls({ source, settings, onChange, section = 'all' }: EditorControlsProps) {
  ...
  return (
    <div className={`editor-controls editor-controls--${section}`} aria-label="图案设置">
      {section !== 'color' && (
        <>
          <section className="control-section control-section--board" aria-label="板型设置">
      ...
      {section !== 'setup' && (
        <section className="control-section control-section--color" aria-label="颜色设置">
          <div className="control-row control-row--select">
            <span>色盘</span>
